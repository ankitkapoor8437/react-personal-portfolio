        ...
        <div id="services">
            <div className="container">
                ...
                <div className="services-list">
                    ...
                    {services.map(({ icon, title, description, learnMoreLink }) => (<div>
                        <i className={icon}></i>
                        <h2>{title}</h2>
                        <p>{description}</p>
                        <br />
